...
FRAMEWORK_NAME="SwiftPusher"
IOS_SUFFIX=""
MAC_SUFFIX=""
CONFIG=$CONFIGURATION
UNIVERSAL_OUTPUTFOLDER="Build/${CONFIG}-universal"
PROJECT_NAME="SwiftPusher"
...
IOS_PLIST_PATH="${PROJECT_DIR}/SwiftPusher/iOS/info.plist"
...
MAC_PLIST_PATH="${PROJECT_DIR}/SwiftPusher/Mac/info.plist"
